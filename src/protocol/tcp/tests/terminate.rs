...
fn creates_valid_fin_ack() -> Result {
    ...
    cloned_state.tcp_state = TcpState::LastAck(LastAck::test_new(WindowState {
...
fn close_established_sends_fin_ack_and_transitions_to_fin_wait_1() -> Result {
    ...
    cloned_state.tcp_state = TcpState::FinWait1(FinWait1::test_new(WINDOW_AFTER_HANDSHAKE));
    cloned_state.snd_nxt += LOCAL_FIN_BYTE;
...
fn fin_wait_1_to_fin_wait_2_on_ack_of_our_fin() -> Result {
    ...
    cloned_state.tcp_state = TcpState::FinWait2(FinWait2::test_new(WindowState {
...
fn simultaneous_close_transitions_through_closing_to_closed() -> Result {
    ...
    cloned_state.tcp_state = TcpState::Closing(Closing::test_new(WindowState {
        snd_wnd: client_fin_ack.window,
        snd_wl1: client_fin_ack.seq_num,
        snd_wl2: client_fin_ack.ack_num,
    }));
...
fn fin_ack_with_data_in_established_buffers_the_untransmittable_remainder() -> Result {
    ...
    expected_state.tcp_state = TcpState::LastAck(LastAck::test_new(WindowState {
        snd_wnd: fin_ack_with_data.window,
        snd_wl1: fin_ack_with_data.seq_num,
        snd_wl2: fin_ack_with_data.ack_num,
    }));
